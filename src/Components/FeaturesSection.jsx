...
const FeaturesSection = () => {
  return (
    <div className="mt-20" id="features">
      ...
      <h2 className="bg-gradient-to-b from-[#000000] to-[#001354] text-transparent bg-clip-text font-bold font-DM flex flex-col text-3xl md:text-6xl py-10 tracking-tighter md:-tracking-widest text-center">Streamlined for easy<span className='text-center'>management</span></h2>
      ...
      <div className="flex flex-col lg:flex-row items-center justify-center gap-8 mt-16">
        <div className="md:w-[486px] w-[370px] h-[538px] text-center shadow-xl py-10 rounded-3xl border-2 border-gray-100">
            <img src="/src/assets/Framer/cube-helix.png" className="m-auto"/>
        ...
        <div className="md:w-[486px] w-[370px] h-[538px] text-center shadow-xl py-10 rounded-3xl border-2 border-gray-100">
            <img src="/src/assets/Framer/cube-helix 1.png" className="m-auto"/>
            <div className="w-[385px] h-[129px] m-auto mt-2 space-y-3">
