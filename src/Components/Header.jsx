    ...
    <header>
      <div className="flex items-center justify-between bg-[#EAEEFE] h-20 px-2">
        ...
        <nav className="items-center md:space-x-5 lg:space-x-7 text-lg mr-3 hidden md:flex">
          ...
          <a className="text-gray-600" href="#features">
            Features
          </a>
          <a className="text-gray-600" href="#customers">
            Customers
          </a>
          <a className="text-gray-600" href="#updates">
            Updates
          </a>
          ...
          <a
            className="text-white bg-black w-full px-2 py-2 rounded-xl"
            href="#signUp"
          >
            Get for free
          </a>
      ...
      {isOpen && (
        <div className="md:hidden bg-[#EAEEFE]">
          <nav className="flex flex-col font-semibold space-y-5 p-2">
            ...
            <a
              className="text-white text-center bg-black px-5 py-2 rounded-xl"
              href="#signUp"
            >
              Get for free
            </a>
