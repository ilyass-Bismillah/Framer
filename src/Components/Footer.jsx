    ...
    <div className="bg-black flex flex-col md:flex-row md:items-center justify-between pt-10 md:pt-0">
      <div className="px-3">
        ...
        <div className="px-4 mt-3">
          <p className="font-inter font-medium text-lg text-[#BCBCBC] md:w-[270px]">
            Effortlessly turn your ideas into a fully functional, responsive,
            no-code SaaS website.
          </p>
          <div className="flex items-center space-x-5 mt-10 md:mt-28">
            <a href="">
              <FaXTwitter size={24} color="#808080" />
            </a>
            <a href="">
              <AiFillInstagram size={30} color="#808080" />
            </a>
            <a href="">
              <FaPinterest size={24} color="#808080" />
            </a>
            <a href="">
              <FaLinkedin size={24} color="#808080" />
            </a>
            <a href="">
              <FaTiktok size={24} color="#808080" />
            </a>
            <a href="">
              <FaYoutube size={30} color="#808080" />
            </a>
          </div>
        </div>
      </div>
      <div className="text-[#7B7B7B] flex flex-col md:flex-row md:space-x-16 font-inter font-medium py-12 px-8 md:px-0 overflow-x-auto">
