...
const UpdatesSection = () => {
  return (
    <div className="mt-40" id="updates">
      <p className='font-medium text-base border border-gray-300 rounded-xl px-4 py-2 w-32 m-auto'>Testimonials</p>
      <h2 className="bg-gradient-to-b from-[#000000] to-[#001354] text-transparent bg-clip-text font-bold font-DM flex flex-col w-[163px] md:w-full text-3xl md:text-6xl py-10 tracking-tighter text-center m-auto">What our users say</h2>
       <div className="md:columns-3 justify-items-center md:gap-60 lg:px-32">
          ...
          <div className="p-8 border border-gray-100 rounded-3xl shadow-xl w-[325px] h-[234px] border-opacity-10 opacity-50 hidden sm:block">
            <p className="font-inter font-medium tracking-wider bg-gradient-to-b from-gray-200 to-gray-800 text-transparent bg-clip-text">
              <span className="">As a seasoned designer always on the lookout for innovative</span> tools, Framer.com instantly grabbed my attention.
            </p>
