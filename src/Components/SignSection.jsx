...
const SignSection = () => {
  return (
    <div className='mt-40 md:mt-60 bg-gradient-to-b from-[#FFFFFF] to-[#D2DCFF] relative h-[460px]'id="signUp">
      <h2 className="bg-gradient-to-b from-[#000000] to-[#001354] text-transparent bg-clip-text font-bold font-DM flex flex-col text-4xl w-[200px] md:w-full m-auto md:text-7xl py-10 tracking-tighter text-center">Sign up for free today</h2>
      ...
      <div className="flex items-center justify-center space-x-5 mt-10">
        ...
        <img src={Emojistar} className="absolute md:-left-48 md:-top-16 lg:-top-20 lg:left-0 hidden sm:block"/>
        <img src={Helix} className="absolute md:-right-40 md:top-10 lg:right-0 lg:top-5 hidden sm:block"/>
    </div>
  )
}
